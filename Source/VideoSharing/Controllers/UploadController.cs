...
namespace VideoSharing.Controllers
{
    ...
    public class UploadController : ControllerBase
    {
        ...
        public UploadController(IVideoService videoService, ILogger<VideoModel> logger)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromForm] ApiModels.StandardVideoUploadModel video)
        {
